# Complete CC local interaction panel 2
...
# CC contact: Cys20 in chain A and Cys32 in chain F.
select local_cys, (chain A and resi 20) or (chain F and resi 32)
...
hide dashes, all
delete CC_A20_F32
distance CC_A20_F32, (chain A and resi 20 and name SG), (chain F and resi 32 and name SG)
set dash_color, cys_s_gold, CC_A20_F32
set dash_width, 3.5, CC_A20_F32
set dash_length, 0.12, CC_A20_F32
set dash_gap, 0.30, CC_A20_F32
...
# png CC_local_A20_F32.png, 1800, 1600, dpi=300, ray=1
