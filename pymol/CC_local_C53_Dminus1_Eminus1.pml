# Complete CC local interaction panel 1
# Load CC.pse, then run this script.
...
set_color CC_A, [0.55, 0.05, 0.12]
set_color CC_B, [0.76, 0.16, 0.22]
set_color CC_C, [0.94, 0.43, 0.43]
set_color CC_D, [0.00, 0.29, 0.36]
set_color CC_E, [0.00, 0.49, 0.52]
set_color CC_F, [0.28, 0.72, 0.68]
color CC_A, chain A
color CC_B, chain B
color CC_C, chain C
color CC_D, chain D
...
# CC contact cluster: Cys53 in chain C with Cys-1 in chains D and E.
select local_cys, (chain C and resi 53) or (chain D and resi -1) or (chain E and resi -1)
...
set_color CC_surface_warm, [0.96, 0.79, 0.79]
set_color CC_surface_cool, [0.72, 0.90, 0.90]
hide surface, all
show surface, local_surface
set surface_color, CC_surface_warm, chain A+B+C
set surface_color, CC_surface_cool, chain D+E+F
...
hide dashes, all
delete CC_C53_Dminus1
delete CC_C53_Eminus1
distance CC_C53_Dminus1, (chain C and resi 53 and name SG), (chain D and resi -1 and name SG)
distance CC_C53_Eminus1, (chain C and resi 53 and name SG), (chain E and resi -1 and name SG)
set dash_color, cys_s_gold, CC_C53_Dminus1
set dash_color, cys_s_gold, CC_C53_Eminus1
set dash_width, 3.5, CC_C53_Dminus1
set dash_width, 3.5, CC_C53_Eminus1
set dash_length, 0.12, CC_C53_Dminus1
set dash_length, 0.12, CC_C53_Eminus1
set dash_gap, 0.30, CC_C53_Dminus1
set dash_gap, 0.30, CC_C53_Eminus1
...
set label_size, 30
set label_font_id, 7
# Separate the two labels so the two Cys--Cys distances do not overlap.
set label_position, [0.0, 0.0, 0.0]
set label_position, [3.0, 2.0, 0.0], CC_C53_Dminus1
set label_position, [-3.0, -2.0, 0.0], CC_C53_Eminus1

hide everything, hydro
zoom local_surface, 7

# png CC_local_C53_Dminus1_Eminus1.png, 1800, 1600, dpi=300, ray=1
